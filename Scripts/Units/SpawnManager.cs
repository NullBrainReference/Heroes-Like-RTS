...
public class SpawnManager : MonoBehaviour
{
    ...
    public void StartSpawning()
    {
        ...
        StartCoroutine(SpawnCoroutine(group1.Units, _spawnsLeft));
        StartCoroutine(SpawnCoroutine(group2.Units, _spawnsRight));
    }

    private IEnumerator SpawnCoroutine(List<Unit> units, List<Spawner> spawnersGroup)
    {
